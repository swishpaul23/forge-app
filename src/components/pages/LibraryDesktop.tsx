  ...
  return (
    <div className={isSecondaryMode ? "" : "page"} style={isSecondaryMode ? { padding: "28px" } : { maxWidth: "100%" }}>
      ...
      {!isSecondaryMode && hasMain && mode === "main" && (
        <div style={{ fontFamily: "'IBM Plex Mono',monospace", fontWeight: 'var(--mono-weight)', fontSize: 10, letterSpacing: ".1em", color: "var(--warn)", marginTop: 10 }}>
          ...
          {TEMPLATES.map((t, i) => {
            ...
            return (
              <div key={t.id}
                ...
                {isSecondaryMode ? (
                  <div style={{ marginTop: 8, fontFamily: "'IBM Plex Mono',monospace", fontWeight: 'var(--mono-weight)', fontSize: 10.5, color: "var(--text-2)", lineHeight: 1.55 }}>
                    {t.blurb}
                  </div>
                ) : (
                  <div style={{ marginTop: 10, fontFamily: "'IBM Plex Mono',monospace", fontWeight: 'var(--mono-weight)', fontSize: 10.5, letterSpacing: ".14em", textTransform: "uppercase", color: active === t.id ? "var(--text-0)" : "var(--accent)", opacity: .9, display: "flex", alignItems: "center", gap: 6 }}>
        ...
        <div style={{ display: isSecondaryMode ? "none" : "flex", flexDirection: "column" }}>
          {!selected ? (
            <div style={{
              ...
              <div style={{ fontFamily: "'IBM Plex Mono',monospace", fontWeight: 'var(--mono-weight)', fontSize: 10, letterSpacing: ".22em", textTransform: "uppercase", color: "var(--text-3)", opacity: .5 }}>
            ...
            <div className="lib-detail">
              ...
              <div style={{ display: "inline-flex", alignItems: "center", gap: 6, marginBottom: 16, fontFamily: "'IBM Plex Mono',monospace", fontWeight: 'var(--mono-weight)', fontSize: 10.5, letterSpacing: ".14em", textTransform: "uppercase", background: "var(--bg-2)", border: "1px solid var(--border-1)", borderRadius: 6, padding: "4px 10px" }}>
