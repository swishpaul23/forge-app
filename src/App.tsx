...
// SETTINGS
// ============================================================
export const _Settings = ({ theme, setTheme, tone, setTone, userName, setUserName }: { theme: string; setTheme: (t: string) => void; tone: string; setTone: (t: string) => void; userName: string; setUserName: (n: string) => void }) => {
  const themes = [
    ...
    <div className="page">
      ...
      <div className="settings-grid" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:16,marginTop:24,alignItems:"start"}}>
        ...
        <div style={{display:"flex",flexDirection:"column",gap:16}}>
          ...
          <div className="srow a4">
            <div className="srow-title">Theme</div>
            <div className="srow-desc">Fourteen environments. Pick your headspace.</div>
